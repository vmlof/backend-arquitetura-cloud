...
public class CadastrarFuncionarioValidator : AbstractValidator<CadastrarFuncionarioCommand>
{
    ...
    public CadastrarFuncionarioValidator()
    {
        RuleFor(x => x.Cpf).NotEmpty().WithMessage("CPF e obrigatorio.");
